...
public class HuaweiPush extends CordovaPlugin {
    ...
    public void getHuaweiToken(CallbackContext callbackContext) {
        new Thread() {
            ...
            public void run() {
                try {
                    String appId = AGConnectServicesConfig.fromContext(HuaweiPush.this.cordova.getActivity()).getString("client/app_id");
                    String token = HmsInstanceId.getInstance(HuaweiPush.this.cordova.getActivity()).getToken(appId, "HCM");
